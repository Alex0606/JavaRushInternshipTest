...
<table class="mytable">
    ...
    <table>
        <tr>
            <td><form action = "sortByUnnecessary" ><input type="submit" value="Page1" title="Page1"></form></td>

            <td><form action = "sortByUnnecessaryPage2" ><input type="submit" value="Page2" title="Page2"></form></td>

            <td><form action = "sortByUnnecessaryPage3" ><input type="submit" value="Page3" title="Page3"></form></td>
        </tr>
    </table>
